config_despliegue = {
    ...
    # 1. Fechas y seriales
    "fecha_del_estudio": "2026-07-01", # Indica el mes al que corresponde el estudio (i.e: Si el estudio se hizo en Marzo, pero los datos son de Enero; se coloca enero como fecha del estudio)
    "fecha_de_inicio_pruebas_lab": "2026-07-18 15:00", # Formato: 'AAAA-MM-DD HH:MM:SS'
    "fecha_de_fin_pruebas_lab": "2026-07-19 16:00", # Formato: 'AAAA-MM-DD HH:MM:SS'
