...
def graficar_batimetria_en_mapa(axe: Axes, 
                                datos_de_batimetria: dict, 
                                config: ProcesadoConfig) -> None:
    """
    Descripción:
    ...
    contornos = axe.contour(lon, lat, elevation, levels=curvas_de_batimetria, colors='gray', linestyles='--', linewidths=0.8)
    ...
    axe.clabel(contornos, fmt='%d', fontsize=config.tamanio_de_letra-5, colors='black', manual=manual_positions, inline=True, inline_spacing=5)
