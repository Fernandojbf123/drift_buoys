...
def ruta_al_excel_para_crear_documentos_101():
    """Obtiene un valor de la configuración general de forma dinámica"""
    ruta_al_NAS = os.getenv("ruta_al_NAS")
    carpeta = configs.configuracion_documentos.ruta_al_excel_para_crear_documentos_101
...
def hoja_del_excel_para_crear_documetos_101():
    """Obtiene un valor de la configuración general de forma dinámica"""
    return configs.configuracion_documentos.hoja_del_excel_para_crear_documetos_101
